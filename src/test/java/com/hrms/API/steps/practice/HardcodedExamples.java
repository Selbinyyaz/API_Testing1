...
public class HardcodedExamples {
	...
	String token = " Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1OTU2OTI1NjgsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTU5NTczNTc2OCwidXNlcklkIjoiNjU4In0.jsdifmTU03zpT7rqAnKUGFo3ZvLS-CxteilWesmXoD4";
	...
	public void sampleTestNotes() {
		...
		// String token = " Bearer
		// eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1OTUxNjg2MzEsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTU5NTIxMTgzMSwidXNlcklkIjoiNjU4In0.7WSH-Nua7YkkD4ORRnqheRcasm4jQ-F0TZkLygxNbV0";
		/**
	...
	public void aPostcreateEmployee() {
		 ...
		 * employee id as global variable so that we may we use it with our other calls
		 */
...
//		}
	...
	@Test
	public void fpatchPatchpartiallyUpdating() {

		RequestSpecification patchPartiallyUpdatingRequest = given().header("Content-Type", "application/json")
				.header("Authorization", token).body("{\n" + "  \"employee_id\": \"" + employeeID + "\",\n"
						+ "  \"emp_firstname\": \"partiallyUpdatedFirstName\"\n" + "  \n" + "}");

		Response patchPartiallyUpdatingResponse = patchPartiallyUpdatingRequest.when()
				.patch("/updatePartialEmplyeesDetails.php");

		patchPartiallyUpdatingResponse.prettyPrint();
	}

	@Test
	public void gDeletedeEmployee() {
